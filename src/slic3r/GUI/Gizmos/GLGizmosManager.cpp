...
void GLGizmosManager::switch_gizmos_icon_filename()
{
    ...
    for (auto& gizmo : m_gizmos) {
        ...
        case (EType::BrimEars):
            ...
            break;
        case (EType::HoleFill):
            gizmo->set_icon_filename(m_is_dark ? "toolbar_hole_fill_dark.svg" : "toolbar_hole_fill.svg");
            break;
        }
...
bool GLGizmosManager::init()
{
    ...
    m_gizmos.emplace_back(new GLGizmoHoleFill(m_parent, m_is_dark ? "toolbar_hole_fill_dark.svg" : "toolbar_hole_fill.svg", EType::HoleFill));
